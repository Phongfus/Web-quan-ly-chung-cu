export default {
  ...
  'component.globalHeader.avatar.personal': 'Cá nhân',
  'component.globalHeader.avatar.logout': 'Đăng xuất',
  'component.globalHeader.avatar.language': 'Ngôn ngữ',
  'component.globalHeader.avatar.back': 'Quay lại',
};