...
const controller = __importStar(require("./resident.controller"));
...
router.put("/:id", (0, role_middleware_1.requireRole)("ADMIN"), controller.updateResident);
router.delete("/:id", (0, role_middleware_1.requireRole)("ADMIN"), controller.deleteResident);
